...
**最新更新（Bug 修复）**：
- ✅ 地址输入模式已修复：数字键现在只追加到地址框，不会混入消息内容
- ✅ PTT 按键已禁用：在地址输入模式下，PTT 会被忽略（请用 MENU 键发送）
- ✅ 提示对话框已启用："Enter pager addr\nthen press MENU" 会正确显示
